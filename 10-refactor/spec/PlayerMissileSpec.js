...
var canvas, ctx;
  ...
  it("PlayerMissile", function(){
    ...
    expect(playerMissile.x).toBe(10+2/2);
    expect(playerMissile.y).toBe(10+10);
  ...
  it("PlayerMissile.draw",function(){
    ...
    expect(SpriteSheet.draw).toHaveBeenCalledWith(ctx,'missile',playerMissile.x, playerMissile.y,0)
  });
